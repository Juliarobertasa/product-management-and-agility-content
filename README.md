# Conteúdos Gratuitos para Iniciar em Produto & Agilidade
...
- conteúdos básicos de tecnologia para PMs/POs  
- conteúdos de Produto e Agilidade organizados de forma sequencial  

Tudo pensado especialmente para:

- Pessoas iniciantes na área de Produto  
- Estagiários(as) e Juniores  
- Profissionais migrando de outras áreas  
- PMs e POs que querem treinar alguém novo no time  
...
Se você conhece algum conteúdo gratuito, confiável e relevante, fique à vontade para abrir uma **issue** ou enviar um **pull request**.
